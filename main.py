...
def load_vgg(sess, vgg_path):
    ...
    o3 = graph.get_tensor_by_name(vgg_layer3_out_tensor_name)
    o4 = graph.get_tensor_by_name(vgg_layer4_out_tensor_name)
    o7 = graph.get_tensor_by_name(vgg_layer7_out_tensor_name)
    
    return w1, keep, o3,o4,o7
...
def optimize(nn_last_layer, correct_label, learning_rate, num_classes):
    ...
    """
    # TODO: Implement function
    # following sections from classroom and video
    logits = tf.reshape(nn_last_layer, (-1, num_classes))
    labels = tf.reshape(correct_label, (-1,num_classes))
    # loss function as in classroom
